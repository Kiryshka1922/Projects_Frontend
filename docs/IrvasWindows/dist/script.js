...
/* harmony export */ });
/* harmony import */ var _checkInputs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./checkInputs */ "./src/js/modules/checkInputs.js");
...
function changeModalState(state) {
  ...
  (0,_checkInputs__WEBPACK_IMPORTED_MODULE_0__["default"])("#width");
  (0,_checkInputs__WEBPACK_IMPORTED_MODULE_0__["default"])("#height");
  state["profile"] = 'tree';
...
const form = state => {
  ...
  (0,_checkInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('input[name="user_phone"]');
  const Message = {
    loading: "Загрузка ...",
  ...
  forms.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      state = {};
      PostData('http://localhost:3000/api/data', JSON.stringify(data)).then(res => {
        console.log(res);
...
const tabs = (headerSelector, itemSelector, contentSelector, activeClass, display = 'block') => {
  ...
  header.addEventListener('click', e => {
    ...
    if (e.target || target.classList.contains(itemSelector.replace(/\./, '')) || target.parentNode.classList.contains(itemSelector.replace(/\./, ''))) {
      tabs.forEach((item, i) => {
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(OrderState);
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_engineer_btn', ".popup_engineer", ".popup_engineer .popup_close");
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])('.phone_link', ".popup", ".popup .popup_close");
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])(".popup_calc_btn", ".popup_calc", ".popup_calc_close");
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])(".popup_calc_button", ".popup_calc_profile", ".popup_calc_profile_close", false);
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])(".popup_calc_profile_button", ".popup_calc_end", ".popup_calc_end_close", false);
  ...
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(OrderState);
